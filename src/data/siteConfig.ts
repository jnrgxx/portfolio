export const siteConfig = {
  ...
  bio: 'Building fullstack applications with C# - .NET, Java - Spring Boot, ReactJS, Python, and modern software engineering practices.',
  status: 'Available for Software Engineering opportunities',
  snapshotRole: 'Software Engineer',
