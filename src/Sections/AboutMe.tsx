...
export default function AboutMe() {
  return (
    <section id="about" aria-labelledby="about-heading" className="section-shell p-4 font-mono text-left h-full">
      ...
      <div className="px-4 pb-4 space-y-4">
        ...
        <ul className="text-xs text-text-secondary space-y-1.5 m-0 pl-4 list-disc">
